...
# Load datasets
df1_cleaned = pd.read_csv('Dasboard/Guanyuan_cleaned.csv')
df2_cleaned = pd.read_csv('Dasboard/Aotizhongxin_cleaned.csv')
df3_cleaned = pd.read_csv('Dasboard/Tiantan_cleaned.csv')
...
st.sidebar.image("Dasboard/Air Quality.png")  
